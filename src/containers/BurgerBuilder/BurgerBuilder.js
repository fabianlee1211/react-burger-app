...
const mapDispatchToProps = dispatch => {
	return {
		onAddIngredient: (ig) => dispatch({type: actionTypes.ADD_INGREDIENTS, ingredientName: ig}),
		onRemoveIngredient: (ig) => dispatch({type: actionTypes.REMOVE_INGREDIENTS, ingredientName: ig}),
	}
};
